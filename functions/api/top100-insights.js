    ...
    const rows = await db.prepare(`
      ...
      candidate_rows AS (
        SELECT
          ...
          NULL AS market_sell_through_30d,
          NULL AS market_sell_through_90d,
...
function insightRowToApi(row) {
  ...
  return {
    ...
    market_sell_through_30d: market.sell_thru_rate_30d ?? market.sell_through_30d ?? "",
    market_sell_through_90d: market.sell_thru_rate_90d ?? market.sell_through_90d ?? "",
...
function onDeckCandidateRowToApi(row) {
  ...
  return {
    ...
    market_sell_through_30d: row.market_sell_through_30d ?? "",
    market_sell_through_90d: row.market_sell_through_90d ?? "",
